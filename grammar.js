module.exports = grammar({
  ...
  rules: {
    ...
    ruleset: $ => seq($.selectors, optional(","), "{", repeat($.ruleset_body), "}"),
    ruleset_body: $ => choice($.declarations, $.ruleset),
    selectors: $ => commaSep1($.selector, ","),
    declarations: $ => commaSep1($.declaration, ";"),
    selector: $ => repeat1(choice("Map", $.layer, $.class, $.filter, $.attachment)),
    filter: $ => seq("[", choice($.identifier, $.string), $.comparison, choice($.number, $.string, $.boolean, "null"), "]"),
    ...
    color_hex_long: $ => seq("#", /[0-9a-f]{6}/),
    color_hex_short: $ => seq("#", /[0-9a-f]{3}/),
